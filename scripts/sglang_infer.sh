...
# data_name_list=("refcoco-train-refbox-exclude-onlyflip" )
...
# nohup python -m sglang.launch_server \
#   --model-path  /storage/openpsi/models/plm-3b-official-checkpoint/snapshots/31e3665b544e2dbac215e80200923139fb398975/ \
#   --host 0.0.0.0 --port 30000 \
#   --nnodes 1 --node-rank 0 \
#   --dp-size 8 \
#   --tp-size 1 \
